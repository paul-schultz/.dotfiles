...
vim.api.nvim_set_keymap('', 'hlb', "<cmd>lua require'hop'.hint_lines({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR })<cr>", {}) 
-- Hop line after cursor
vim.api.nvim_set_keymap('', 'hla', "<cmd>lua require'hop'.hint_lines({ direction = require'hop.hint'.HintDirection.AFTER_CURSOR })<cr>", {}) 
-- Hop word
vim.api.nvim_set_keymap('', 'hww', "<cmd>lua require'hop'.hint_words()<cr>", {}) 
-- Hop word before cursor
vim.api.nvim_set_keymap('', 'hwb', "<cmd>lua require'hop'.hint_words({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR })<cr>", {}) 
-- Hop word after cursor
vim.api.nvim_set_keymap('', 'hwa', "<cmd>lua require'hop'.hint_words({ direction = require'hop.hint'.HintDirection.AFTER_CURSOR })<cr>", {}) 
-- Hop char 1
